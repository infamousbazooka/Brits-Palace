                                ...
                                <ul class="slides">
                                    <li>
                                        ...
                                        <div class="slide-info">
                                            <p class="sli_price"> FRONT FACADE </p>
                                            <p class="sli_titl"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. </p>
                                        </div>
                                    </li>
                                    <li>
                                        <img src="images/slider/slider_2.jpg" alt="Slider image" />
                                        <div class="slide-info">
                                            <p class="sli_price"> THE DINE </p>
                                            <p class="sli_titl"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. </p>
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div class="slide-info">
                                            <p class="sli_price"> MAIN LOBBY </p>
                                            <p class="sli_titl"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. </p>
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div class="slide-info">
                                            <p class="sli_price"> DINING TABLE </p>
                                            <p class="sli_titl"> Lorem ipsum dolor sit amet, consectetuer adipiscing elit. </p>
                                        </div>
                                    </li>
                                    <li>
                                        <img src="images/slider/slider_5.jpg" alt="Slider image" />
                                        <div class="slide-info">
                                            <p class="sli_price"> THE KITCHEN </p>
                                            <p class="sli_titl"> Lorem ipsum dolor sit amet, consectetuer adipiscing elit. </p>
                                        </div>
                                    </li>
                                </ul>
